...
public class AdminOnderzoeken extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_onderzoeken);
    ...
    // onderzoeken inlezen in listview
    private void readOnderzoeken() {
        final List<Onderzoek> onderzoeken = db.getOnderzoeken();

        ArrayAdapter<Onderzoek> adapter = new ArrayAdapter<Onderzoek>(this, android.R.layout.simple_list_item_1, onderzoeken);

        final ListView lijst = (ListView) findViewById(R.id.lijstonderzoeken);
