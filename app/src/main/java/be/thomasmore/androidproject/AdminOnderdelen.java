...
public class AdminOnderdelen extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_onderdelen);
    ...
    // onderdelen inlezen in listview
    private void readOnderdelen() {
        final List<Onderdeel> onderdelen = db.getOnderdelen();

        ArrayAdapter<Onderdeel> adapter = new ArrayAdapter<Onderdeel>(this, android.R.layout.simple_list_item_1, onderdelen);

        final ListView lijst = (ListView) findViewById(R.id.lijstonderdelen);
