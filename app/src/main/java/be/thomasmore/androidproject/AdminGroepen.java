...
public class AdminGroepen extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_groepen);
    ...
    // groepen inlezen in listview
    private void readGroepen() {
        final List<Groep> groepen = db.getGroepen();

        ArrayAdapter<Groep> adapter = new ArrayAdapter<Groep>(this, android.R.layout.simple_list_item_1, groepen);

        final ListView lijst = (ListView) findViewById(R.id.lijstgroepen);
